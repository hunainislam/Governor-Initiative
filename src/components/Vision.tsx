  ...
  return (
    <div className="xl:w-[1300px] lg:w-[90%] w-[95%] m-auto sm:mt-20 mt-10 border-b border-zinc-300 pb-10">
        ...
        <div className="grid sm:grid-cols-3 grid-cols-1 gap-5 mt-10 m-3 sm:m-0">
          <Image src={"/images/solo1.jpg"} alt="solopenur1" loading="lazy" width={1088} height={896} className=" shadow-2xl shadow-black rounded-lg h-[300px] object-cover w-full" decoding="async"/>

          <Image src={"/images/solo2.jpg"} alt="solopenur1" loading="lazy" width={500} height={375} className=" shadow-2xl shadow-black rounded-lg h-[300px] w-full" decoding="async"/>

          <Image src={"/images/solo3.jpg"} alt="solopenur1" loading="lazy" width={1088} height={896} className=" shadow-2xl shadow-black rounded-lg h-[300px] object-cover w-full" decoding="async"/>
        </div>
